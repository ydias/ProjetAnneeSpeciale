...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
    ...
    <div class="modal-content">
     ...
     <form action="Fct_ListeAdmin/ajouter_admin.php" method="post" class="form-horizontal" id='form_ajout_admin'> 
...
$('#admin_grid').DataTable({
         ...
         "ajax":{
            url :"Fct_ListeAdmin/fetch_admins.php", // json datasource
          ...
          "columns": [
                ...
                { "data": "3", "bSearchable": false, "bSortable": false, "sWidth": "40px"},
                {
                    ...
                    "data": function (data) {
                        return  '<form action="Fct_ListeAdmin/supprimer_admin.php" class="supprimer" method="post"><input type="hidden" name="id" value="'+data[0]+'"><input class="btn btn-danger" type="submit" value="Supprimer"  onclick="if(!confirm(`Voulez-vous Supprimer cet admin?\n(Cette action est définitive)`)) return false;"></form>'
                    }},
              	{
                    "data": "Inquiry", "bSearchable": false, "bSortable": false, "sWidth": "40px",
                    "data": function (data) {
