...
<?php 
  require_once('Fct_Historique/Class_action.php');
?>

<!DOCTYPE html>
<html>
  <head>
    <link rel="stylesheet" type="text/css" href="Fct_Accueil/accueil.css" />
    <link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" />
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.13/css/dataTables.bootstrap.min.css" />
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/responsive/2.1.1/css/responsive.bootstrap.min.css" />
    <link href="Fct_Historique/dashbord.css" rel="stylesheet">
...
<!-- Fin navbar -->
      ...
      <div class="row">
        <section class="col-sm-12">
          ...
          <?php
            ...
            require('BDD/BDD_connexion.php');               /*BOUCLE D'AFFICHAGE DE L'HISTORIQUE*/
    ...
    <script  language="JavaScript" type="text/javascript" src="Fct_Historique/Changement_page.js"></script>
