...
<html>
	...
	<head>
		...
		<script src='js/pageEtudient.js'></script>
	</head>
	<body>
		<header>
		...
		<div class="container">
			...
			<form action="actualisation.php" method="post" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<?php echo '<input class="col-lg-2  col-lg-offset-1" value="'.$tab['dernier_etablissement_secondaire_frequente_nom'].'" type="text" name="NomDernierEtablissementSecondaire"/>' ; ?>
				...
				<div class="row">
					<label class="col-lg-1">Nom</label>
					<?php echo ' <input class="col-lg-2  col-lg-offset-1" value="'.$tab['derniere_ecole_frequentee_ens_sup_nom'].'" type="text"  name="NomDernierEtablissement"/>' ; ?>
					<label class="col-lg-1 col-lg-offset-1">Ville</label>
				...
				<div class="row">
					...
					<?php
						if ($tab['nom_etablissement_1']!='none') {
							echo '<input class="col-lg-2" id="AutreEtablissement1nom" value="'.$tab['nom_etablissement_1'].'" type="text" name="AutreEtablissement1" />' ; 
						}else{
				...
				<div class="row">
					<label class="col-lg-2">Etablissement</label>
					<input class="col-lg-2" type="text" name="AutreEtablissement2" />
					<label class="col-lg-2 col-lg-offset-1">Spécialité</label>
					<input class="col-lg-2" type="text" name="AutreSpe2">
				</div><br/>
				<div class="row">
					<label class="col-lg-2">Etablissement</label>
					<input class="col-lg-2" type="text" name="AutreEtablissement3" />
					<label class="col-lg-2 col-lg-offset-1">Spécialité</label>					
					<input class="col-lg-2" type="text" name="AutreSpe3">
				</div><br/>
				<div class="row">
