    ...
    <div class="row" id="identifient">
		...
		<div class="container">
			...
			<form action="envoieEmail.php" method="post">
				...
				<div class="row">
					<label class="col-lg-1">Nom</label>
					<input class="col-lg-2 col-lg-offset-1" type="text" name="NomDernierEtablissementSecondaire"/>
				...
				<div class="row">
					<label class="col-lg-1">Nom</label>
					<input class="col-lg-2 col-lg-offset-1" type="text"  name="NomDernierEtablissement"/>
					<label class="col-lg-1 col-lg-offset-1">Ville</label>
				...
				<div class="row">
					...
					<label class="col-lg-1">OUI <input id="oui" name="inscription" value="oui" type="radio"></label>
					<label class="col-lg-1">NON <input id="non" name="inscription" value="non" type="radio"></label>
				</div><br/>
				<div class="row">
					<label class="col-lg-6" id="precisionVoeux">précisez la spécialité et l'établisement</label>
				</div>
				<div class="row">
					<label class="col-lg-2" id="AutreEtablissement1nom">Etablissement</label>
					<input class="col-lg-2" type="text" id="AutreEtablissement1" name="AutreEtablissement1" />
					<label class="col-lg-2 col-lg-offset-1" id="AutreSpe1nom">Spécialité</label>
					<input class="col-lg-2" type="text" id="AutreSpe1" name="AutreSpe1">
				</div><br/>
				<div class="row">
					<label class="col-lg-2" id="AutreEtablissement2nom">Etablissement</label>
					<input class="col-lg-2" type="text" id="AutreEtablissement2" name="AutreEtablissement2" />
					<label class="col-lg-2 col-lg-offset-1" id="AutreSpe2nom">Spécialité</label>
					<input class="col-lg-2" type="text" id="AutreSpe2" name="AutreSpe2">
				</div><br/>
				<div class="row">
					<label class="col-lg-2" id="AutreEtablissement3nom">Etablissement</label>
					<input class="col-lg-2" type="text" id="AutreEtablissement3" name="AutreEtablissement3" />
					<label class="col-lg-2 col-lg-offset-1" id="AutreSpe3nom">Spécialité</label>
					<input class="col-lg-2" type="text" id="AutreSpe3" name="AutreSpe3">
				</div><br/>
				<div class="row">
				...
				<div class="row">
					...
					<label class="col-lg-2" id="inputLycee1">Lequel ?</label><input class="col-lg-2"  id="inputLycee" type="text" name="connaissanceSalon"/>
				</div>
				<div class="row">
					<label class="col-lg-2"id='salon'><input  type="radio" name="connaissance" value="salon"/> Salon</label>
					<label class="col-lg-2" id="inputSalon1">Lequel ?</label><input class="col-lg-2"  id="inputSalon" type="text" name="connaissanceSalon"/>
				</div>
				<div class="row">
				...
				<div class="row">
					...
					<label class="col-lg-2" id="inputPresse1">Quelle parution ?</label><input class="col-lg-2" id="inputPresse" type="text" name="connaissancePresse"/>
				</div>
				<div class="row">
					<label class="col-lg-2"id='internet'><input  type="radio" name="connaissance" value="internet"/> Internet</label>
					<label class="col-lg-2"id="inputInternet1">Quel site ?</label><input class="col-lg-2" id="inputInternet" type="text" name="connaissanceInternet"/>
				</div>
				<div class="row">
					<label class="col-lg-2"id='autre'><input  type="radio" name="connaissance" value="autre"/> autre(s)</label>
					<label class="col-lg-2"id="inputautre1">Préciser :</label><input class="col-lg-2" type="text" id="inputautre" name="connaissanceAutres"/>
